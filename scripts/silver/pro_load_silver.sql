...
BEGIN
    ...
    BEGIN TRY
		...
		SELECT
			...
			CASE 
				WHEN UPPER(LTRIM(prd_line)) = 'M' THEN 'Mountain'
				WHEN UPPER(LTRIM(prd_line)) = 'R' THEN 'Road'
				WHEN UPPER(LTRIM(prd_line)) = 'S' THEN 'Other Sales'
				WHEN UPPER(LTRIM(prd_line)) = 'T' THEN 'Touring'
				ELSE 'n/a'
